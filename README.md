...
## 기능
- **실시간 이상행동 탐지**: CCTV 카메라를 통해 입력된 비디오 스트림에서 비정상적인 행동을 실시간으로 감지합니다.
...
## 설치 방법
```bash
git clone https://github.com/yourusername/home-cctv-abnormal-behavior-detection.git
cd home-cctv-abnormal-behavior-detection
